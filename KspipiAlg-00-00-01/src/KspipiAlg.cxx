...
StatusCode KspipiAlg::initialize()
{
    ...
    else
    {
        ...
        if (m_tuple0)
        {
            ...
            status = m_tuple0->addItem("truth_decayR0", truthdecayR0_temp0);
...
StatusCode KspipiAlg::execute()
{
    ...
    double m_mcdecayL, m_mcdecayL0, m_mcdecayR0;
    ...
    m_mcdecayR0 = sqrt((Ks_fposi.x() - Ks_iposi.x()) * (Ks_fposi.x() - Ks_iposi.x()) + (Ks_fposi.y() - Ks_iposi.y()) * (Ks_fposi.y() - Ks_iposi.y()));
