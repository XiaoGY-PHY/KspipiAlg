...
jobOptions_KspipiAlg_txt_dependencies = ../share/jobOptions_KspipiAlg.txt


install_runtimeinstall :: ${install_dir}/jobOptions_KspipiAlg.txt
	@if test ! "${installarea}" = ""; then\
	  echo "installation done"; \
	fi

${install_dir}/jobOptions_KspipiAlg.txt :: ../share/jobOptions_KspipiAlg.txt
	@if test ! "${installarea}" = ""; then \
	  d=`dirname ../share/jobOptions_KspipiAlg.txt`; \
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_install_action) "$${d}" "jobOptions_KspipiAlg.txt" "$(install_dir)" "cp -R" ; \
	fi
...
install_runtimeuninstall ::
	@if test ! "${installarea}" = ""; then \
	  ...
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_uninstall_action) "$${d}" "jobOptions_KspipiAlg.txt" "$(install_dir)" "cp -R" ; \
	fi
