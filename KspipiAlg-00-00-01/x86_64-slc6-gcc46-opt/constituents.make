...
#cmt_local_tagfile = $(KspipiAlg_tag).make
cmt_local_tagfile = $(bin)$(KspipiAlg_tag).make
...
cmt_local_setup_KspipiAlg = $(bin)setup_KspipiAlg$$$$.make
...
KspipiAlg_extratags = -tag_add=target_KspipiAlg

#$(cmt_local_tagfile_KspipiAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_KspipiAlg) ::
else
$(cmt_local_tagfile_KspipiAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_KspipiAlg); then /bin/rm -f $(cmt_local_tagfile_KspipiAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(KspipiAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_KspipiAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_KspipiAlg)"; \
	  test ! -f $(cmt_local_setup_KspipiAlg) || \rm -f $(cmt_local_setup_KspipiAlg); \
	  trap '\rm -f $(cmt_local_setup_KspipiAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(KspipiAlg_extratags) show setup >$(cmt_local_setup_KspipiAlg) && \
	  if [ -f $(cmt_final_setup_KspipiAlg) ] && \
	    \cmp -s $(cmt_final_setup_KspipiAlg) $(cmt_local_setup_KspipiAlg); then \
	    \rm $(cmt_local_setup_KspipiAlg); else \
	    \mv -f $(cmt_local_setup_KspipiAlg) $(cmt_final_setup_KspipiAlg); fi
...
not_KspipiAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(KspipiAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
KspipiAlgdirs :
	@if test ! -d $(bin)KspipiAlg; then $(mkdir) -p $(bin)KspipiAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)KspipiAlg
else
KspipiAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)KspipiAlg
#
#$(cmt_local_KspipiAlg_makefile) :: $(KspipiAlg_dependencies) $(cmt_local_tagfile_KspipiAlg) build_library_links dirs KspipiAlgdirs
#else
#$(cmt_local_KspipiAlg_makefile) :: $(KspipiAlg_dependencies) $(cmt_local_tagfile_KspipiAlg) build_library_links dirs
#endif
#else
#$(cmt_local_KspipiAlg_makefile) :: $(cmt_local_tagfile_KspipiAlg)
#endif

ifdef cmt_KspipiAlg_has_target_tag

ifndef QUICK
$(cmt_local_KspipiAlg_makefile) : $(KspipiAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building KspipiAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(KspipiAlg_extratags) build constituent_config -out=$(cmt_local_KspipiAlg_makefile) KspipiAlg
else
$(cmt_local_KspipiAlg_makefile) : $(KspipiAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_KspipiAlg) ] || \
	  [ ! -f $(cmt_final_setup_KspipiAlg) ] || \
	  $(not_KspipiAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building KspipiAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(KspipiAlg_extratags) build constituent_config -out=$(cmt_local_KspipiAlg_makefile) KspipiAlg; \
	  fi
endif
...
$(cmt_local_KspipiAlg_makefile) : $(KspipiAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building KspipiAlg.make"; \
	  $(cmtexe) -f=$(bin)KspipiAlg.in -tag=$(tags) $(KspipiAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_KspipiAlg_makefile) KspipiAlg
else
$(cmt_local_KspipiAlg_makefile) : $(KspipiAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)KspipiAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_KspipiAlg) ] || \
	  [ ! -f $(cmt_final_setup_KspipiAlg) ] || \
	  $(not_KspipiAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(KspipiAlg_extratags) build constituent_makefile -out=$(cmt_local_KspipiAlg_makefile) KspipiAlg

KspipiAlg :: $(KspipiAlg_dependencies) $(cmt_local_KspipiAlg_makefile) dirs KspipiAlgdirs
	$(echo) "(constituents.make) Starting KspipiAlg"
	@if test -f $(cmt_local_KspipiAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_KspipiAlg_makefile) KspipiAlg; \
	  fi
#	@$(MAKE) -f $(cmt_local_KspipiAlg_makefile) KspipiAlg
	$(echo) "(constituents.make) KspipiAlg done"

clean :: KspipiAlgclean

KspipiAlgclean :: $(KspipiAlgclean_dependencies) ##$(cmt_local_KspipiAlg_makefile)
	$(echo) "(constituents.make) Starting KspipiAlgclean"
	@-if test -f $(cmt_local_KspipiAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_KspipiAlg_makefile) KspipiAlgclean; \
	fi
	$(echo) "(constituents.make) KspipiAlgclean done"
#	@-$(MAKE) -f $(cmt_local_KspipiAlg_makefile) KspipiAlgclean

##	  /bin/rm -f $(cmt_local_KspipiAlg_makefile) $(bin)KspipiAlg_dependencies.make

install :: KspipiAlginstall

KspipiAlginstall :: $(KspipiAlg_dependencies) $(cmt_local_KspipiAlg_makefile)
	$(echo) "(constituents.make) Starting install KspipiAlg"
	@-$(MAKE) -f $(cmt_local_KspipiAlg_makefile) install
	$(echo) "(constituents.make) install KspipiAlg done"

uninstall : KspipiAlguninstall

$(foreach d,$(KspipiAlg_dependencies),$(eval $(d)uninstall_dependencies += KspipiAlguninstall))

KspipiAlguninstall : $(KspipiAlguninstall_dependencies) ##$(cmt_local_KspipiAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall KspipiAlg"
	@if test -f $(cmt_local_KspipiAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_KspipiAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_KspipiAlg_makefile) uninstall
	$(echo) "(constituents.make) uninstall KspipiAlg done"

remove_library_links :: KspipiAlguninstall
...
#cmt_local_tagfile_install_runtime = $(KspipiAlg_tag)_install_runtime.make
cmt_local_tagfile_install_runtime = $(bin)$(KspipiAlg_tag)_install_runtime.make
...
#cmt_final_setup_install_runtime = $(bin)KspipiAlg_install_runtimesetup.make
...
#cmt_local_tagfile_install_runtime = $(KspipiAlg_tag).make
cmt_local_tagfile_install_runtime = $(bin)$(KspipiAlg_tag).make
cmt_final_setup_install_runtime = $(bin)setup.make
#cmt_final_setup_install_runtime = $(bin)KspipiAlgsetup.make
cmt_local_install_runtime_makefile = $(bin)install_runtime.make
...
#cmt_local_tagfile_config = $(KspipiAlg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(KspipiAlg_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)KspipiAlg_configsetup.make
...
#cmt_local_tagfile_config = $(KspipiAlg_tag).make
cmt_local_tagfile_config = $(bin)$(KspipiAlg_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)KspipiAlgsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(KspipiAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(KspipiAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)KspipiAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(KspipiAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(KspipiAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)KspipiAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(KspipiAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(KspipiAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)KspipiAlg_makesetup.make
...
#cmt_local_tagfile_make = $(KspipiAlg_tag).make
cmt_local_tagfile_make = $(bin)$(KspipiAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)KspipiAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(KspipiAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(KspipiAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)KspipiAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(KspipiAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(KspipiAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)KspipiAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(KspipiAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(KspipiAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)KspipiAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(KspipiAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(KspipiAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)KspipiAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(KspipiAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(KspipiAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)KspipiAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(KspipiAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(KspipiAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)KspipiAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(KspipiAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(KspipiAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)KspipiAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(KspipiAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(KspipiAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)KspipiAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(KspipiAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(KspipiAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)KspipiAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(KspipiAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(KspipiAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)KspipiAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(KspipiAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(KspipiAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)KspipiAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(KspipiAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(KspipiAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)KspipiAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(KspipiAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(KspipiAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)KspipiAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(KspipiAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(KspipiAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)KspipiAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
cmt_local_setup_KspipiAlg_check_install_runtime = $(bin)setup_KspipiAlg_check_install_runtime$$$$.make
...
KspipiAlg_check_install_runtime_extratags = -tag_add=target_KspipiAlg_check_install_runtime

#$(cmt_local_tagfile_KspipiAlg_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_KspipiAlg_check_install_runtime) ::
else
$(cmt_local_tagfile_KspipiAlg_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_KspipiAlg_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_KspipiAlg_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(KspipiAlg_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_KspipiAlg_check_install_runtime)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_KspipiAlg_check_install_runtime)"; \
	  test ! -f $(cmt_local_setup_KspipiAlg_check_install_runtime) || \rm -f $(cmt_local_setup_KspipiAlg_check_install_runtime); \
	  trap '\rm -f $(cmt_local_setup_KspipiAlg_check_install_runtime)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(KspipiAlg_check_install_runtime_extratags) show setup >$(cmt_local_setup_KspipiAlg_check_install_runtime) && \
	  if [ -f $(cmt_final_setup_KspipiAlg_check_install_runtime) ] && \
	    \cmp -s $(cmt_final_setup_KspipiAlg_check_install_runtime) $(cmt_local_setup_KspipiAlg_check_install_runtime); then \
	    \rm $(cmt_local_setup_KspipiAlg_check_install_runtime); else \
	    \mv -f $(cmt_local_setup_KspipiAlg_check_install_runtime) $(cmt_final_setup_KspipiAlg_check_install_runtime); fi
...
not_KspipiAlg_check_install_runtime_dependencies = { n=0; for p in $?; do m=0; for d in $(KspipiAlg_check_install_runtime_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
KspipiAlg_check_install_runtimedirs :
	@if test ! -d $(bin)KspipiAlg_check_install_runtime; then $(mkdir) -p $(bin)KspipiAlg_check_install_runtime; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)KspipiAlg_check_install_runtime
else
KspipiAlg_check_install_runtimedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)KspipiAlg_check_install_runtime
#
#$(cmt_local_KspipiAlg_check_install_runtime_makefile) :: $(KspipiAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_KspipiAlg_check_install_runtime) build_library_links dirs KspipiAlg_check_install_runtimedirs
#else
#$(cmt_local_KspipiAlg_check_install_runtime_makefile) :: $(KspipiAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_KspipiAlg_check_install_runtime) build_library_links dirs
#endif
#else
#$(cmt_local_KspipiAlg_check_install_runtime_makefile) :: $(cmt_local_tagfile_KspipiAlg_check_install_runtime)
#endif

ifdef cmt_KspipiAlg_check_install_runtime_has_target_tag

ifndef QUICK
$(cmt_local_KspipiAlg_check_install_runtime_makefile) : $(KspipiAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building KspipiAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(KspipiAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_KspipiAlg_check_install_runtime_makefile) KspipiAlg_check_install_runtime
else
$(cmt_local_KspipiAlg_check_install_runtime_makefile) : $(KspipiAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_KspipiAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_KspipiAlg_check_install_runtime) ] || \
	  $(not_KspipiAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building KspipiAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(KspipiAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_KspipiAlg_check_install_runtime_makefile) KspipiAlg_check_install_runtime; \
	  fi
endif
...
$(cmt_local_KspipiAlg_check_install_runtime_makefile) : $(KspipiAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building KspipiAlg_check_install_runtime.make"; \
	  $(cmtexe) -f=$(bin)KspipiAlg_check_install_runtime.in -tag=$(tags) $(KspipiAlg_check_install_runtime_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_KspipiAlg_check_install_runtime_makefile) KspipiAlg_check_install_runtime
else
$(cmt_local_KspipiAlg_check_install_runtime_makefile) : $(KspipiAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(bin)KspipiAlg_check_install_runtime.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_KspipiAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_KspipiAlg_check_install_runtime) ] || \
	  $(not_KspipiAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(KspipiAlg_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_KspipiAlg_check_install_runtime_makefile) KspipiAlg_check_install_runtime

KspipiAlg_check_install_runtime :: $(KspipiAlg_check_install_runtime_dependencies) $(cmt_local_KspipiAlg_check_install_runtime_makefile) dirs KspipiAlg_check_install_runtimedirs
	$(echo) "(constituents.make) Starting KspipiAlg_check_install_runtime"
	@if test -f $(cmt_local_KspipiAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_KspipiAlg_check_install_runtime_makefile) KspipiAlg_check_install_runtime; \
	  fi
#	@$(MAKE) -f $(cmt_local_KspipiAlg_check_install_runtime_makefile) KspipiAlg_check_install_runtime
	$(echo) "(constituents.make) KspipiAlg_check_install_runtime done"

clean :: KspipiAlg_check_install_runtimeclean

KspipiAlg_check_install_runtimeclean :: $(KspipiAlg_check_install_runtimeclean_dependencies) ##$(cmt_local_KspipiAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting KspipiAlg_check_install_runtimeclean"
	@-if test -f $(cmt_local_KspipiAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_KspipiAlg_check_install_runtime_makefile) KspipiAlg_check_install_runtimeclean; \
	fi
	$(echo) "(constituents.make) KspipiAlg_check_install_runtimeclean done"
#	@-$(MAKE) -f $(cmt_local_KspipiAlg_check_install_runtime_makefile) KspipiAlg_check_install_runtimeclean

##	  /bin/rm -f $(cmt_local_KspipiAlg_check_install_runtime_makefile) $(bin)KspipiAlg_check_install_runtime_dependencies.make

install :: KspipiAlg_check_install_runtimeinstall

KspipiAlg_check_install_runtimeinstall :: $(KspipiAlg_check_install_runtime_dependencies) $(cmt_local_KspipiAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install KspipiAlg_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_KspipiAlg_check_install_runtime_makefile) install
	$(echo) "(constituents.make) install KspipiAlg_check_install_runtime done"

uninstall : KspipiAlg_check_install_runtimeuninstall

$(foreach d,$(KspipiAlg_check_install_runtime_dependencies),$(eval $(d)uninstall_dependencies += KspipiAlg_check_install_runtimeuninstall))

KspipiAlg_check_install_runtimeuninstall : $(KspipiAlg_check_install_runtimeuninstall_dependencies) ##$(cmt_local_KspipiAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall KspipiAlg_check_install_runtime"
	@if test -f $(cmt_local_KspipiAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_KspipiAlg_check_install_runtime_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_KspipiAlg_check_install_runtime_makefile) uninstall
	$(echo) "(constituents.make) uninstall KspipiAlg_check_install_runtime done"

remove_library_links :: KspipiAlg_check_install_runtimeuninstall
